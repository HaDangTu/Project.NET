namespace MotelManagement.Migrations
{
    ...
    public partial class PopulateData : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("INSERT INTO [dbo].[Guests] ([id] ,[name] ,[birthday] ,[gender_id] ,[identity_card_number] ,[home_town] ,[occupation] ,[room_id] ,[state_id]) VALUES ('G000031', N'Trương Thị Nga', '1995-03-03 00:00:00', 'G02', '272748264', N'Quảng Nam', N'Nhân viên', 'R0004', 'S01')");
            Sql("INSERT INTO [dbo].[Guests] ([id] ,[name] ,[birthday] ,[gender_id] ,[identity_card_number] ,[home_town] ,[occupation] ,[room_id] ,[state_id]) VALUES ('G000032', N'Nguyễn Hoàng Trâm', '1995-09-20 00:00:00', 'G02', '272748265', N'Quảng Nam', N'Nhân viên', 'R0004', 'S01')");
            ...
            Sql("INSERT INTO [dbo].[Guests] ([id] ,[name] ,[birthday] ,[gender_id] ,[identity_card_number] ,[home_town] ,[occupation] ,[room_id] ,[state_id]) VALUES ('G000043', N'Trần Hoàng Trung', '1995-09-20 00:00:00', 'G01', '272748276', N'Cà Mau', N'Công nhân', 'R0010', 'S01')");
            Sql("INSERT INTO [dbo].[Guests] ([id] ,[name] ,[birthday] ,[gender_id] ,[identity_card_number] ,[home_town] ,[occupation] ,[room_id] ,[state_id]) VALUES ('G000044', N'Nguyễn Văn Thanh', '1995-10-21 00:00:00', 'G01', '272748277', N'Cà Mau', N'Công nhân', 'R0010', 'S01')");
            Sql("INSERT INTO [dbo].[Guests] ([id] ,[name] ,[birthday] ,[gender_id] ,[identity_card_number] ,[home_town] ,[occupation] ,[room_id] ,[state_id]) VALUES ('G000045', N'Đoàn Văn Đức', '1995-01-22 00:00:00', 'G01', '272748278', N'Cà Mau', N'Công nhân', 'R0010', 'S01')");
            Sql("INSERT INTO [dbo].[Guests] ([id] ,[name] ,[birthday] ,[gender_id] ,[identity_card_number] ,[home_town] ,[occupation] ,[room_id] ,[state_id]) VALUES ('G000046', N'Nguyễn Phước Hoàng', '1995-02-23 00:00:00', 'G01', '272748279', N'Cà Mau', N'Công nhân', 'R0010', 'S01')");
        }
